    ...
    return (V, ae) => (L(), Z("div", {
      ...
      X("div", {
        ...
        s.file.type != "image" ? (L(), Oe(Y(Pt), {
          key: 1,
          class: "text-gray-500",
          name: Y(Mi)[s.file.type] || Y(Mi).text,
          type: "solid",
          width: "48",
          height: "48"
        }, null, 8, ["name"])) : pe("", !0),
